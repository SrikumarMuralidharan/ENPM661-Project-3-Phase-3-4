...
class Map:
    ...
    def GetUserNodes(self):
        ...
        self.rob_clr = float(input('Clearance (in m): '))
        self.rob_clr = self.rob_clr*1000
        self.rob_rad = 105
    ...
    def StartNode(self):
        ...
        self.StartPoint = [(-1000*float(StartX), -1000*float(StartY)), int(StartTheta)]
    ...
    def GoalNode(self):
        ...
        GoalX = input('goal x: ')
        GoalY = input('goal y: ')
        self.GoalPoint = (-1000*float(GoalX), -1000*float(GoalY))
